...
export default function VehicleDetails() {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between px-10 lg:px-18 py-5 gap-10">
      {/* vehicle details */}
      <div className="bg-white w-full lg:w-1/2 h-full p-6 rounded-xl shadow-md flex flex-col gap-6">
        {/* Vehicle Image */}
