...
export const BookingSchema = z.object({
  firstName: z.string().min(1, "Firstname must not be empty").regex(/^[a-zA-Z]+$/, "Firstname must be characters only"),
  lastName: z.string().min(1, "Lastname must not be empty").regex(/^[a-zA-Z]+$/, "Firstname must be characters only"),
